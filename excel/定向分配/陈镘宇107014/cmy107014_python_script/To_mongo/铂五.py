...
Individual_db = DB["DXTS"]["陈镘宇107014-个人-铂五"]

#使用xlrd打开工作本（excel文件）
book = xlrd.open_workbook(r'D:\白名单\定向分配资源整理\excel\定向分配\陈镘宇107014\名单\铂五.xls')
...
for i in range(sheet.nrows):
    if i == 0:
        ...
        item["是否出售"] = sheet.row_values(i)[4]
        item["是否出租"] = sheet.row_values(i)[5]
