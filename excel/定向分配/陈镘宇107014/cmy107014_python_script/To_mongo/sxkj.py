...
#使用xlrd打开工作本（excel文件）
book = xlrd.open_workbook(r'D:\白名单\定向分配资源整理\excel\定向分配\陈镘宇107014\名单\山西科技.xls')
...
for i in range(sheet.nrows):
    if i != 0:
        ...
        item["公司类型"] = sheet.row_values(i)[4]
        item["负责人姓名"] = None
        item["联络员姓名"] = None
        ...
        item["经营范围"] = None
        item["地址"] = None
        item["法定代表人"] = sheet.row_values(i)[3]
        item["成立日期"] = sheet.row_values(i)[5]
